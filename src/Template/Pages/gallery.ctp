...
<div class="help-tip2">
    <div class="help-tip ">
        <p>En esta página usted encontrará imágenes referentes a cada recorrido, con su respectiva descripción.</p>
    </div>
</div>
...
<title> 
    ...
    <?php foreach ($images as $image): ?>
        <img  data-description="<?php echo $image->description ;?>"  src="<?php echo $image->link_path ;?>">
    <?php endforeach; ?>
